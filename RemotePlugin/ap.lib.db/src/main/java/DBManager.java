...
//    protected static final String sDir = "./app/src/main/java-gen";
    ...
    public static void main(String[] args) throws Exception {
        Schema schema = new Schema(1, "com.remote_plugin.xuancao.remoteplugin.db.bean");
        schema.setDefaultJavaPackageDao("com.remote_plugin.xuancao.remoteplugin.db.dao");
